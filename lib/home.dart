    ...
    return Scaffold(
      ...
      appBar: AppBar(
        leading: PopupMenuButton(
          ...
          itemBuilder: (context) =>[
            PopupMenuItem(child: TextButton(child: Text('Projects',
            ...
            PopupMenuItem(child: TextButton(child: Text('About Me',
              style: TextStyle(color: Colors.white),
            ),
              onPressed: (){
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    myAchiev('007', 'Projects'),
                    myAchiev('96', 'Clients'),
                    myAchiev('93', 'Messages'),
